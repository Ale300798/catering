package com.catering.authentication;
...
import static com.catering.model.Credentials.CHEF_ROLE;
import static com.catering.model.Credentials.ADMIN_ROLE;
...
public class AuthConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers(HttpMethod.GET, "/", "/index", "/login", "/register", "/css/**", "/images/**", "/visualizza/**").permitAll()
                // chiunque (autenticato o no) può mandare richieste POST al punto di accesso per login e register
                .antMatchers(HttpMethod.POST, "/login", "/register", "/modifica").permitAll()
                // solo gli utenti autenticati con ruolo ADMIN possono accedere a risorse con path /admin/**
                .antMatchers(HttpMethod.GET, "/admin/**").hasAnyAuthority(ADMIN_ROLE)
                .antMatchers(HttpMethod.POST, "/admin/**").hasAnyAuthority(ADMIN_ROLE)
                .antMatchers(HttpMethod.GET, "/chef/**").hasAnyAuthority(CHEF_ROLE)
                .antMatchers(HttpMethod.POST, "/chef/**").hasAnyAuthority(CHEF_ROLE)
